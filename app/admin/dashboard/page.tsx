...
// ─────────────────────────────────────────────────────────────────────────────
// THIS FILE WAS MISSING — every link in the app pointed to /admin/dashboard
// but the folder/page didn't exist, causing a 404 for the main admin screen.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function AdminDashboard() {
  ...
  // ── Auth guard (belt-and-suspenders on top of middleware) ─────────────────
  useEffect(() => {
      ...
      <div className="px-4 sm:px-6 lg:px-10 py-8 space-y-8 max-w-screen-xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            >
              <FiArrowLeft className="text-xs" /> Store
            </Link>
        ...
        <div className="rounded-2xl bg-white dark:bg-gray-900/80 border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
          ...
          {!stats?.recentOrders?.length ? (
            <p className="p-8 text-center text-sm text-gray-400 dark:text-gray-500">No orders yet</p>
          ) : (
            <>
              {/* DESKTOP */}
